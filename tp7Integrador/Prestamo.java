...
public class Prestamo implements java.io.Serializable{
    ...
    private void setFechaDevolucion(Calendar p_fechaDevolucion){this.fechaDevolucion = p_fechaDevolucion;}
     ...
     * primero clona la fecha en la que se retiro y le suma los dias de prestamos que asignaron al socio.
